...
from mergers.ministry_amendment_table import merge_minister_responses
...
class MinistryAmendmentTableExtractor(BaseExtractor):
    def __init__(self):
    ...
    def extract(self, documents):
        ...
        print(f'merged result : {all_result}')
